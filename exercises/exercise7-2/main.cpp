/*
 * Программа выполняет шифрование
 * сообщения, путем сдвига каждого
 * символа влево на определенное число
 * битов, указанное конкретно или
 * взятое из ключа.
 * Расшифровка сообщения осуществляется
 * путем сдвига каждого символа вправо.
 */
#include <iostream>
using namespace std;
